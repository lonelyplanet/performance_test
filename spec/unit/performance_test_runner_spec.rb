    ...
    describe 'preparing the tests' do
      describe 'when using chrome release' do
        ...
        it 'uses the correct test profile' do
          chrome_release_runner.tests[0][:cmd].should eq 'DEBUG_ASSETS=true bundle exec cucumber -p performance features/christo/example_performance.feature 2>&1'
        end
      end
      ...
      describe 'when using chrome beta' do
        ...
        it 'uses the correct test profile' do
          chrome_beta_runner.tests[0][:cmd].should eq 'DEBUG_ASSETS=true bundle exec cucumber -p performance features/christo/example_performance.feature 2>&1'
        end
      end
